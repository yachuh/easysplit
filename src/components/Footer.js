            ...
            <div className="viewContainer flex justify-center lg:justify-between lg:items-center lg:gap-2">
                ...
                <ul className="flex items-center lg:items-start text-white gap-5 lg:gap-8">
                    <li className="footer-hover">
                        <Link className="footerLink" to="/stillmore">
                ...
                <h6 className="hidden lg:block text-white">Copyright © 2022 EasySplit All rights reserved</h6>
            </div>
        </footer>
  )
}
        ...
        <footer className="bg-colors-third py-5">
            <ul className="viewContainer flex items-center justify-center text-white gap-14 md:hidden">
                <li className="footer-hover hover:text-colors-fifth">
                    <Link className="footerLink" to="/group">
                        <div className="footerImg-phone"><SupervisedUserCircleOutlined sx={{ fontSize: 45 }} /></div>
                        <p className="footerTxt">拆帳群組</p>
                    </Link>
                </li>
                <li className="footer-hover hover:text-colors-fifth">
                    <Link className="footerLink" to="/">
                        <div className="footerImg-phone"><AddCircleOutline sx={{ fontSize: 45 }} /></div>
                        <p className="footerTxt">新增費用</p>
                    </Link>
                </li>
                <li className="footer-hover hover:text-colors-fifth">
                    <Link className="footerLink" to="/">
                        <div className="footerImg-phone"><AccountCircleOutlined sx={{ fontSize: 45 }} /></div>
                        <p className="footerTxt">會員中心</p>
                    </Link>
                </li>
            </ul>
